-- Product Profitability uses the immutable, deterministic Shopify line-revenue
-- resolver. Stage 1 order eligibility and financials remain authoritative.
begin;
...
with eligible_lines as (
  select c.order_id,c.shopify_created_at,c.canonical_net_revenue,c.observed_purchased_label_cost_gbp,c.covered_payment_fees_gbp,
    o.shipping authoritative_customer_shipping_revenue_gbp,p.id product_id,p.title product_name,l.id order_line_id,l.cogs_quantity eligible_units,
