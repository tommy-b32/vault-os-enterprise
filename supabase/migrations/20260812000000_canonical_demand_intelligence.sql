-- Sprint 21.0: operational demand trust must not depend on supplier-basket policy.
-- Existing columns retain their order. Supplier policy evidence is appended.
