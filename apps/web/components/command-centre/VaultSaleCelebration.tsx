  ...
  return (
    <>
      ...
      <style>{`
        ...
        .vault-sale-card>strong{position:relative;z-index:1;display:block;margin:8px 0 2px;color:#fff0b8;font-size:66px;text-shadow:0 2px 0 #8d5e12,0 0 12px #e9a91e,0 0 34px rgba(255,190,45,.55);line-height:1.05}
