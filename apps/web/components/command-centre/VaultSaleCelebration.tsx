  ...
  return (
    <>
      ...
      <style>{`
        ...
        .vault-sale-logo{width:92px;height:78px;margin:-12px auto 4px;display:grid;place-items:center;overflow:hidden;filter:drop-shadow(0 0 20px rgba(232,188,67,.22))}.vault-sale-logo img{width:118px;height:118px;object-fit:cover;object-position:50% 35%;transform:scale(1.05)}.vault-sale-kicker{color:#e8bc43;font-size:11px;font-weight:900;letter-spacing:.18em}
