      ...
      <section className="cc-middle-grid">
        <article className="cc-card cc-feature-panel cc-executive-briefing">
          ...
          <div className="cc-briefing-body">
            <strong className="cc-briefing-headline">{data.executiveBriefing.headline}</strong>
            <p className="cc-briefing-summary">{data.executiveBriefing.summary}</p>
...
function CommandCentreCockpitStyles() {
  return <style>{`
    ...
    .cc-middle-grid{display:grid;grid-template-columns:1.65fr 1fr;gap:10px;margin-top:10px}.cc-feature-panel{min-height:208px}.cc-executive-briefing{border-top-color:rgba(228,184,63,.65)}.cc-panel-heading{display:flex;align-items:center;justify-content:space-between;padding:10px 12px;border-bottom:1px solid rgba(255,255,255,.07)}.cc-panel-heading h2{margin:0;color:#aeb2ae;font-size:10px;font-weight:500}.cc-panel-heading>a,.cc-panel-heading>span,.cc-feed a,.cc-briefing-focus>a{color:#d9ae3b;font-size:9px;text-decoration:none}.cc-briefing-body{padding:10px 12px}.cc-briefing-headline{display:block;font-size:12px;line-height:1.3}.cc-briefing-summary{margin:4px 0 8px;color:#a1a5a1;font-size:8px;line-height:1.35}.cc-briefing-columns{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}.cc-briefing-columns b,.cc-briefing-focus>b,.cc-briefing-unlocks>b{display:block;margin-bottom:3px;color:#dbae35;font-size:7px;text-transform:uppercase}.cc-briefing-columns ul{margin:0;padding-left:12px;color:#9ba09c;font-size:7px;line-height:1.35}.cc-briefing-columns li{margin:2px 0}.cc-briefing-columns span{color:#747b76;font-size:7px}.cc-briefing-focus{display:grid;grid-template-columns:auto 1fr auto;gap:8px;align-items:center;margin-top:8px;padding:7px 8px;border:1px solid rgba(219,177,67,.18);border-radius:6px}.cc-briefing-focus>b{margin:0}.cc-briefing-focus>strong{font-size:9px}.cc-briefing-focus>span{color:#858c87;font-size:8px}.cc-briefing-unlocks{display:grid;grid-template-columns:auto 1fr;gap:8px;margin-top:6px;color:#929894;font-size:7px}.cc-briefing-unlocks>b{margin:0}.cc-attention-list{padding:4px 12px}.cc-attention strong{font-size:10px}.cc-attention p{margin:3px 0 0;color:#9fa4a0;font-size:8px;line-height:1.25}.cc-attention{display:grid;grid-template-columns:57px 1fr 13px;align-items:center;gap:8px;padding:7px 0;border-bottom:1px solid rgba(255,255,255,.06);color:inherit;text-decoration:none}.cc-attention:last-child{border:0}.cc-priority{padding:4px;border:1px solid rgba(231,181,54,.4);border-radius:5px;color:#e6ba47;font-size:8px;text-align:center;text-transform:uppercase}.cc-priority.is-critical{border-color:rgba(255,91,91,.5);color:#ff7474}.cc-attention>b{color:#e1b23b}.cc-empty{margin:20px;color:#8f9691;font-size:10px}
    ...
    @media(max-width:1200px){.cc-kpi-grid{grid-template-columns:repeat(3,1fr)}.cc-domain-strip{grid-template-columns:repeat(4,1fr)}.cc-snapshot-grid{grid-template-columns:repeat(2,1fr)}}
    @media(max-width:820px){.cc-middle-grid{grid-template-columns:1fr}.cc-page{padding:16px}.cc-page-header{align-items:flex-start}.cc-pulse{min-width:155px}}
    @media(max-width:600px){.cc-page-header{display:grid;gap:12px}.cc-pulse{width:100%}.cc-kpi-grid{display:flex;overflow-x:auto;scroll-snap-type:x mandatory}.cc-kpi-card{min-width:210px;scroll-snap-align:start}.cc-briefing-columns{grid-template-columns:1fr}.cc-briefing-focus{grid-template-columns:1fr}.cc-domain-strip{grid-template-columns:repeat(2,1fr)}.cc-snapshot-grid{grid-template-columns:1fr}.cc-feed-grid{grid-template-columns:1fr}.cc-footer{flex-direction:column;gap:4px}}
  `}</style>;
}
