    ...
    <div className="cc-page">
      ...
      <section className="cc-kpi-grid" aria-label="Headline business metrics">
        ...
        <KpiCard eyebrow="Website Conversion" icon="▽" value={percentValue(data.website.conversionRate)}>
          <span>Sessions {numberValue(data.website.sessions)}</span><span>Live {numberValue(data.website.liveVisitors)}</span>
        </KpiCard>
        <KpiCard eyebrow="Website Traffic" icon="⌁" value={numberValue(data.website.visitors)}>
          <span>Estimated visitors</span><span>UK share {percentValue(data.website.ukTrafficPercentage)}</span>
        </KpiCard>
      ...
      <section className="cc-snapshot-grid" aria-label="Business snapshots">
        <Snapshot title="Sales Funnel" subtitle="Website performance today" icon="▽">
          <MetricRow label="Visitors" value={data.website.visitors} />
