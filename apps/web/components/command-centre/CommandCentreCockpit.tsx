...
function CommandCentreCockpitStyles() {
  return <style>{`
    ...
    @media(max-width:600px){.cc-page{padding:16px}.cc-page-header{display:grid;gap:14px}.cc-page-header h1{font-size:24px}.cc-pulse{width:100%;min-width:0}.cc-kpi-grid{grid-template-columns:1fr}.cc-kpi-card{min-width:0}.cc-kpi-values{grid-template-columns:1fr}.cc-kpi-values>div:nth-child(n){text-align:left}.cc-panel-heading{align-items:flex-start;gap:10px}.cc-briefing-focus{grid-template-columns:1fr}.cc-domain-strip{grid-template-columns:1fr}.cc-snapshot-grid{grid-template-columns:1fr}.cc-feed-grid{grid-template-columns:1fr}.cc-feed>header{align-items:flex-start;gap:10px}.cc-feed-grid article{grid-template-columns:16px minmax(0,1fr)}.cc-feed-grid time{grid-column:2}.cc-footer{flex-direction:column;gap:7px}}
  `}</style>;
}
