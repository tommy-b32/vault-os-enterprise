        ...
        <KpiCard eyebrow="Finance Position" icon="inventory" accent="gold" value={moneyValue(data.finance.ledgerCash)}>
          <div className="cc-finance-support">
            ...
            <section className="cc-recent-ledger" aria-label="Recent cash ledger">
              ...
              {data.finance.recentLedger?.value ? data.finance.recentLedger.value.transactions.length ? <ul>{data.finance.recentLedger.value.transactions.slice(0, 7).map((entry) => (
                <li key={entry.id}>
