...
function AddToDraftButton({ styleId, parentProductId }: { styleId: string; parentProductId: string }) {
  ...
  if (purchaseOrderId) return <div aria-live="polite"><strong>Added to Draft PO</strong><Link className="vault-secondary-button" href={`/purchase-orders/${purchaseOrderId}`}>View Draft PO →</Link></div>;
