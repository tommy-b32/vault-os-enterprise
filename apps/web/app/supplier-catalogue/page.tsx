...
} from "@/components/suppliers/SupplierCatalogueImportWorkspace";
...
export default async function SupplierCataloguePage() {
  try {
    ...
    return (
      <VaultAppShell
        notificationCount={3}
        searchPlaceholder="Search supplier catalogues..."
        systemStatusLabel="Supplier intelligence online"
      >
    ...
    const message =
      error instanceof Error
        ? error.message
        : "An unknown supplier catalogue error occurred.";

    return (
      <VaultAppShell
        searchPlaceholder="Search supplier catalogues..."
        systemStatusLabel="Supplier intelligence unavailable"
      >
        <main className="catalogue-error">
          <h1>Supplier catalogue unavailable</h1>
